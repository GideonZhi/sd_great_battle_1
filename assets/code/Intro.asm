...
!SetBank = #$1B
!SetBank2 = #$1B ;should always be 1 more than SetBank1 (not sure if it's same with HiRom)
!SetOffset = #$8000
...
;includes for intro 
org $1B8000
incbin ./logobits/aglogo.set

org $1B9100
incbin ./logobits/aglogo.map

org $1B9900
incbin ./logobits/aglogo.col
...
;$00/8003 C2 10       REP #$10                A:207D X:0012 Y:00E7 D:0000 DB:00 S:01FF P:envMXdizCHC:0066 VC:000 00 FL:00
